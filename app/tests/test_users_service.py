...
async def test_register_and_authenticate(db_session: AsyncSession):
    u = await user_service.register(db_session, UserCreate(email="zoe@example.com", password="secret123"))
